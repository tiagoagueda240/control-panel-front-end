...
export const CLASSROOM = `${API_URL}/classroom`
export const COURSE = `${API_URL}/course`
export const CURRICULAR_UNITS = `${API_URL}/curricular-units`
export const LOGIN = `${API_URL}/login`
export const REQUEST = `${API_URL}/requests`
export const SCHEDULES = `${API_URL}/time-schedule`
